      ...
      <section className="bg-black dark:text-gray-100 pb-[90px] " >
        ...
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between ">
          ...
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left ">
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start test">
              <a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold rounded dark:bg-violet-400 dark:text-gray-900 test z-40 hover:bg-black ease-in duration-300 hover:border hover:border-violet-400 hover:text-white" id="getstarted">Get Started</a>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 relative test" id="herobanner1-photos">
              <img src="https://i.pinimg.com/236x/f7/b0/5d/f7b05d5bb3f523a73aa01efeed5be53d.jpg" alt="" className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 test" id="herobanner-photo1" />
              <img src="https://i.pinimg.com/236x/94/38/56/94385674bd23ed0a4a1249c054f1fb04.jpg" alt="" className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 test" id="herobanner-photo2" />
        ...
        <div id="offers">
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 dark:text-gray-100 ml-[10vw] test">
            ...
            <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3 ml-[5vw]">
