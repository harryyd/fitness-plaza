...
const HeroBanner = () => {
  return (
    <div>
      <section className="bg-black dark:text-gray-100 pb-[90px] test" >
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between test">
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left test">
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start test">
              <a rel="noopener noreferrer" href="#" className="px-8 py-3 text-lg font-semibold rounded dark:bg-violet-400 dark:text-gray-900 test">Get Started</a>
            </div>
          </div>
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 relative test" id="herobanner1-photos ">
            ...
            <img src="https://i.pinimg.com/236x/94/38/56/94385674bd23ed0a4a1249c054f1fb04.jpg" alt="" className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 test" style={{ marginLeft: "200px", marginBottom: "80px", height: "500px", position: "absolute" }} id="herobanner-photo2"/>
          </div>
        </div>

        <div className='flex test' id="herobanner2">
          <h1 className=' text-5xl font-extrabold pl-10 pr-20 '>WE ARE A HIGH QUALITY GYM DEDICATED TO AFFORDABLE HEALTH AND WELLNESS.</h1>
        ...
        <div className='display: flex justify-around mt-[150px] relative pb-[30px] mb-[40px] test' id="image-target" >
          <img src="https://images.squarespace-cdn.com/content/v1/624b3c6e48a38b1e837e59fb/6dd4f4e5-5131-49b1-9223-5a305b4deb4b/2888486jpgOriginalDelivery.jpg?format=1500w" alt="image1" style={{ marginRight: "35vh", marginTop: "100px", height: "64vh",}} id="herobanner-inter-photo1"/>
          <img src="https://images.squarespace-cdn.com/content/v1/624b3c6e48a38b1e837e59fb/2fba5f51-a18e-4ee7-93b6-0b53db29dfc2/1716607jpgOriginalDelivery.jpg?format=500w" alt="image2" style={{ marginLeft: "35vh", marginBottom: "100px", height: "64vh", position: "absolute" }} id="herobanner-inter-photo2"/>
        </div>
